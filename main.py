...
def attack(char_name: str, char_class: str) -> str:
    ...
    return f'{char_name} нанес какой-то урон'


def defence(char_name: str, char_class: str) -> str:
    """Генерирует количество очков защиты в зависимости от выбранного.
    типа персонажа и возвращает строковое сообщение о выполненном
    блокировании атаки.
    """
    if char_class == 'warrior':
